...
Echo           ^>  \ Enable Windows \ -GGS- \ ^<            \ V  VibranceGui \
Echo           ^>   \ Type ^!BACK^!    \ -TwUi \ ^<            \ B  BattleNET   \
Echo           ^>    \ Type EnableWIN \ -:)^!^! \ ^<            \ A  RiotGAMES   \
Echo   -----------------------------------------------       \----------------\
...
Echo.       ----------------------------------------------        ------------------
echo.
set /p "BLTWUI=>           ( Type '1,14' To Proceed ) > "
if "%BLTWUI%"=="1" (
    Echo.
    Echo.
    ...
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!!DOWNLOADING. FireFoxDebloat!!', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    ...
    Echo.
    Echo. 
    del "C:\Windows\System32\BLTW.bat"
    ...
    Echo.
    Echo.
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('DOWNLOADING. VibranceGUI', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    curl -g -k -L -# -o "%UserProfile%\AppData\Local\Temp\vibranceGUI.exe" "https://github.com/ael2222222222222222222222222222/p/raw/main/vibranceGUI.exe"
    call "%UserProfile%\AppData\Local\Temp\vibranceGUI.exe"
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!!SET TO 300!!.', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    goto BLTWUI
) else if "%BLTWUI%"=="B" (
    Echo.
    Echo.
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('DOWNLOADING. !!BattleNET!!', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    curl -g -k -L -# -o "%UserProfile%\AppData\Local\Temp\Battle.net-Setup.exe" "https://downloader.battle.net//download/getInstallerForGame?os=win&gameProgram=BATTLENET_APP&version=Live"
    call "%UserProfile%\AppData\Local\Temp\Battle.net-Setup.exe"
    del /s /f /q %temp%\*.*
    rd /s /q %temp%
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!!DOWNLOADED. "BattleNET"!!.', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    del "%UserProfile%\AppData\Local\Temp\Battle.net-Setup.exe"
    goto BLTWUI
) else if "%BLTWUI%"=="A" (
    Echo.
    Echo.
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('DOWNLOADING. !!RiotGAMES!!', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    curl -g -k -L -# -o "%UserProfile%\AppData\Local\Temp\Install VALORANT.exe" "https://valorant.secure.dyn.riotcdn.net/channels/public/x/installer/current/live.live.ap.exe"
    call "%UserProfile%\AppData\Local\Temp\Install VALORANT.exe"
    del /s /f /q %temp%\*.*
    rd /s /q %temp%
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!!DOWNLOADED. SUCCESSFULLY!!.', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    del "%UserProfile%\AppData\Local\Temp\Install VALORANT.exe"
    goto BLTWUI
) else (
    Echo.
    Echo.
