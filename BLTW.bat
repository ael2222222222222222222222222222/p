...
if "%BLTWUI%"=="1" (
    ...
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('COMPLETED THE INSTALLATION. !!DOWNLOADING. FireFoxDebloat!!.', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
