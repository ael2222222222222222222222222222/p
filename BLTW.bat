...
if "%BLTWUI%"=="1" (
    ...
    Echo.
    Echo.
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('You Back To. !!Tweaking PC Ui!!.', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    ...
    powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Please type a number between 1 and 15 to proceed.', 'BlotwareUI', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);"
    goto BLTWUI
)
